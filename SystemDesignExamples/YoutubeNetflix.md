...
**Where would videos be stored?**  Videos can be stored in a distributed file storage system like  [HDFS  10](https://en.wikipedia.org/wiki/Apache_Hadoop#HDFS)  or  [GlusterFS  3](https://en.wikipedia.org/wiki/GlusterFS).
